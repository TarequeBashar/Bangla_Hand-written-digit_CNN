# -*- coding: utf-8 -*-
"""
Created on Sun Jul  4 01:59:54 2021
...
class main:
    def __init__(self, master):
        ...
        self.pre = [None, None]
        self.bs = 8.5
        self.c = Canvas(self.master,bd=3,relief="ridge", width=300, height=282, bg='black')
        ...
        Label(f1,text="Using CNN",fg="red",font=("",15)).pack()
        Label(f1,text="Draw On The Canvas Alongside",fg="red",font=("",15)).pack()
    ...
    def getResult(self,e):
        ...
        img.save("dist.png")
        imgPath="dist.png"
        model = load_model('saved_models/BanglaModel.h5')
    ...
    def paint(self, e):
        self.c.create_line(self.pre[0], self.pre[1], e.x, e.y, width=self.bs * 2, fill='white', capstyle=ROUND,
                           smooth=TRUE)
